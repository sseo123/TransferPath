...
export const DVC_CATALOG: CollegeCourse[] = [
  ...
  { localCode: "MATH-193", canonicalId: CANONICAL_COURSES.CALC_2, title: "Calculus II", units: 5, offerings: ["fall", "spring"], prerequisites: [CANONICAL_COURSES.CALC_1]  },
  { localCode: "MATH-292", canonicalId: CANONICAL_COURSES.CALC_3, title: "Analytic Geometry and Calculus III", units: 5, offerings: ["fall", "spring"], prerequisites: [CANONICAL_COURSES.CALC_2]  },
  ...
  { localCode: "MATH-195", canonicalId: CANONICAL_COURSES.DISCRETE_MATH, title: "Discrete Mathematics", units: 3, offerings: ["fall", "spring"], prerequisites: [CANONICAL_COURSES.CALC_2]  },
  { localCode: "MATH-294", canonicalId: CANONICAL_COURSES.DIFF_EQ, title: "Differential Equations", units: 3, offerings: ["fall", "spring"], prerequisites: [CANONICAL_COURSES.CALC_3, CANONICAL_COURSES.LINEAR_ALGEBRA]  },
  ...
  //Ethnic Studies
  { localCode: "ETHNIC-STUDIES", canonicalId: CANONICAL_COURSES.ETHNIC_STUDIES, title: "Ethnic Studies", units: 3, offerings: ["fall", "spring", "summer"], prerequisites: []  },
];
