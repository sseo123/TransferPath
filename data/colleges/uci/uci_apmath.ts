...
export const UCI_APMATH_REQUIREMENTS: RequirementGraph = {
  requiredChains: [
    ...
    { canonicalId: CANONICAL_COURSES.PHYSICS_1, category: "PHYSICS", isCritical: false },
    { canonicalId: CANONICAL_COURSES.PHYSICS_2, category: "PHYSICS", isCritical: false },
