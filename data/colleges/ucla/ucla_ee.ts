...
export const UCLA_EE_REQUIREMENTS: RequirementGraph = {
  requiredChains: [
    {
    ...
    {
      canonicalId: CANONICAL_COURSES.ADVANCED_CS,
      category: "CS",
      isCritical: true,
    },
    {
    ...
    // { canonicalId: CANONICAL_COURSES.ENGINEERING_2, category: "ENGINEERING", isCritical: true },
    {
    ...
    {
      canonicalId: CANONICAL_COURSES.PHYSICS_1,
      category: "PHYSICS",
      isCritical: true,
    },
    {
      canonicalId: CANONICAL_COURSES.PHYSICS_2,
      category: "PHYSICS",
      isCritical: true,
    },
    {
      canonicalId: CANONICAL_COURSES.PHYSICS_3,
      category: "PHYSICS",
      isCritical: true,
    },
    {
