...
export const UCSD_MECHE_REQUIREMENTS: RequirementGraph = {
  requiredChains: [    
    ...
    { canonicalId: CANONICAL_COURSES.ENGINEERING_USING_MATLAB, category: "ENGINEERING", isCritical: true },
    { canonicalId: CANONICAL_COURSES.ENGINEERING_PROPERTIES_OF_MATERIALS, category: "ENGINEERING", isCritical: true },
    { canonicalId: CANONICAL_COURSES.ENGINEERING_THERMODYNAMICS, category: "ENGINEERING", isCritical: true },
